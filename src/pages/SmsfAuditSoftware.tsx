...
const features = [
  { pill: "AI DOCUMENT ANALYSIS", title: "Every figure read. Every document reconciled.", desc: "Financials, bank statements, investment reports, trust deeds, minutes. Read simultaneously and reconciled across every document. Every finding linked to its exact source. No skimming. No assumptions.", img: "https://puxbjitnqpsxixxilxsu.supabase.co/storage/v1/object/public/public-assets/Screenshot%202026-03-19%20at%203.13.54%20pm.png", imgSide: "right" as const },
